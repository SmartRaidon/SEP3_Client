...
public class SignalRGameService : IGameService
{
    ...
    public SignalRGameService(NavigationManager navigationManager)
    {
        _hubConnection = new HubConnectionBuilder()
            .WithUrl(navigationManager.ToAbsoluteUri("/gameHub"))  // SignalR endpoint on the server
            .Build();
    }
    ...
    public async Task OnReceiveMoveAsync(Func<MoveDto, Task> callback)
    {
        /*
    ...
    public async Task OnInvalidMoveAsync(Func<string, Task> callback)
    {
        /*
